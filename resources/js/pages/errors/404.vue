    ...
    <div>
        <div class="row justify-content-center">
            <div class="col-md-12 text-center">
                <svg id="f20e0c25-d928-42cc-98d1-13cc230663ea"
                    data-name="page not found"
                    xmlns="http://www.w3.org/2000/svg"
                    xmlns:xlink="http://www.w3.org/1999/xlink"
                    width="320.16" height="280.81"
                    ...
                    <rect x="375.66" y="136.55" width="199.84" height="47.27" transform="translate(-212.94 43.72) rotate(-12.11)" fill="#40a6c8"/>
                    <path d="M460.93,91.9a27.93,27.93,0,1,0,33.17,21.45A27.93,27.93,0,0,0,460.93,91.9ZM470.17,135a16.12,16.12,0,1,1,12.38-19.14A16.12,16.12,0,0,1,470.17,135Z" transform="translate(-189.92 -59.59)" fill="#40a6c8"/><rect x="257.89" y="116.91" width="437.02" height="603.82" fill="#e0e0e0"/>
                    <g opacity="0.5">
                        ...
                        <rect x="377.02" y="104.56" width="199.84" height="47.27" fill="#40a6c8"/>
                        <path d="M666.86,118a27.93,27.93,0,1,0,27.93,27.93A27.93,27.93,0,0,0,666.86,118Zm0,44.05A16.12,16.12,0,1,1,683,145.89,16.12,16.12,0,0,1,666.86,162Z" transform="translate(-189.92 -59.59)" fill="#40a6c8"/>
                    <g opacity="0.5"><rect x="15.27" y="737.05" width="3.76" height="21.33" fill="#47e6b1"/>
            ...
            <div class="col-md-12">
                <h2 class="mb-5 mt-5 text-center">404 — Not found</h2>
