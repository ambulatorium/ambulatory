<script type="text/ecmascript-6">
    export default {
        ...
        mounted() {
            document.title = "Schedule — Reliqui";
        ...
        methods: {
            loadResource() {
                this.http().get('/api/doctor-profile/' + this.Reliqui.user.id).then(response => {
                    this.form.doctor = response.data.entry.id;
                });

                this.http().get('/api/healthcare-locations').then(response => {
            ...
            loadSchedule() {
                ...
                this.http().get('/api/working-hours/' + this.id).then(response => {
                    ...
                    if (this.id != 'new') {
                        this.form.location = response.data.entry.location_id;
            ...
            save() {
                ...
                this.http().post('/api/working-hours/' + this.id, this.form).then(response => {
                    this.$router.push({name: 'working-hours'});
        ...
        <div v-if="ready && entry">
            <div class="card-body">
                <form>
                    ...
                    <div class="form-group row">
                        <label for="start_date_time" class="col-md-4 col-form-label text-md-right">
                            Start date
                    ...
                    <div class="form-group row">
                        <label for="end_date_time" class="col-md-4 col-form-label text-md-right">
                            End date
                            <small class="form-text text-muted mt-0">
                                <em>required (M/D/Y - H:M) UTC</em>
                            </small>
                    ...
                    <div class="form-group row">
                        <label for="service_time" class="col-md-4 col-form-label text-md-right">Estimated service time</label>
