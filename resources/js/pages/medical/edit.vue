<script type="text/ecmascript-6">
    export default {
        ...
        mounted() {
            document.title = "Medical Form — Reliqui";
        ...
        methods: {
            fillForm(data) {
                ...
                if (this.id != 'new') {
                    ...
                    this.form.patient_full_name = data.patient_full_name;
            ...
            deleteMedicalForm(){
                this.alertConfirm("Are you sure you want to delete this medical form?", () => {
                    this.http().delete('/api/medical-form/' + this.id, this.form).then(response => {
        ...
        <div v-if="ready && entry" class="card-body">
                ...
                <div class="col-sm-8">
                    <div class="row pb-2">
                        <div class="col-sm-12 pb-2">
                            ...
                            <form-errors :errors="form.errors.patient_full_name"></form-errors>
                        </div>
                        <div class="col-sm-6">
                            <input type="date"
                                class="form-control bg-light border-0"
            ...
            <div class="row">
                ...
                <div class="col-sm-8">
                    ...
                    <button class="btn btn-danger" @click="deleteMedicalForm" v-if="id != 'new'">
                        Delete this form
                    </button>
                </div>
            </div>
